...
const contracts = [
  ...
  [script, ['hourCycle: \'h23\'', 'isBreedReady', 'breed-ready', 'animalHue', 'paintAnimal', 'cardQueue', 'confirmCardStep', 'apply-all-cards', 'reset-sort'], 'app.js'],
  [css, ['font-size:17px', 'character-card', 'breed-ready', '--animal-hue', 'table-layout:fixed', '@media'], 'styles.css']
];
